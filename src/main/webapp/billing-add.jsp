...
<%--                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">--%>
<%--                            卡号:   <input type="text" name="cardsid" placeholder="卡号" autocomplete="off" class="layui-input"></div>--%>
                        <div  class="layui-inline layui-show-xs-block">
                            体检人: <input type="text" name="cname" placeholder="体检人" autocomplete="off" class="layui-input"></div><br>
                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">
                            性别:   <input type="text" name="sex" placeholder="性别" autocomplete="off" class="layui-input"></div>
                        <div class="layui-inline layui-show-xs-block">
                            年龄:   <input type="text" name="age" placeholder="年龄" autocomplete="off" class="layui-input"></div><br>
                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">
                            手机:   <input type="text" name="telephone" placeholder="手机" autocomplete="off" class="layui-input"></div>
                        <div class="layui-inline layui-show-xs-block">
                            金额 :  <input type="text" name="cprice" placeholder="金额" autocomplete="off" class="layui-input"></div><br>
                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">
                            套餐:   <select name="teid" id="teid" onchange="mySelect()" style="width: 165px;height: 30px">
                        ...
                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">
                            项目:   <select name="prid" id="prid" style="width: 165px;height: 30px">
                            <option value="">请选择</option>
<%--                            <option value="01">体检鼻咽喉镜检查</option>--%>
<%--                            <option value="02">过敏原全套</option>--%>
<%--                            <option value="03">体检大肝功全套</option>--%>
<%--                            <option value="04">食入性过敏原筛查</option>--%>
                        </select>
                        </div>
                        <div style="margin: 30px"  class="layui-inline layui-show-xs-block">
                        <button type="submit" class="layui-btn" lay-submit="" lay-filter="sreach" value="开单">
                            <i class="layui-icon">&#xe615;</i>开单</button>
                        </div>
                    </form>
</div>
</body>
